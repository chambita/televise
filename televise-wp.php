...
Televise-WP.php
-----------
Televise-WP is a plugin for embedding online videos with ease in on your WordPress site.
...
function optix_televise( $attributes ) {
	...
	return "<iframe type='text/html' src='".$url.$id."' frameborder='0' height='".$height."' width='".$width."' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>";
}
add_shortcode('televise', 'optix_televise');
?>